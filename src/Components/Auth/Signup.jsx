    ...
    <div>
      ...
      <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <h2 className="text-center text-yellow-300 text-sm">To use InstaSnapGram , Please enter your details</h2>
        </div>
            ...
            <div>
              ...
              <div class="mt-2">
                ...
                onChange={handlechange}
                  ...
                  class={`block w-full rounded-md border-2 ${borderError?"border border-red-500" :null} py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset  sm:text-sm sm:leading-6 p-2.5`}
                />
              </div>
            ...
            <div>
              ...
              <div class="mt-2">
                <input
                  ...
                  class={`block w-full rounded-md border-2 ${borderError?"border border-red-500" :null} py-1.5 text-black shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset  sm:text-sm sm:leading-6 p-2.5`}
                />
              </div>
              <div className="text-yellow-300 text-sm">{error.usernameerr}</div>
            </div>
